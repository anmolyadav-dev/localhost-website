...
export default function Card() {
  return (
    <div className=" pb-7 pt-[130px] px-7 bg-bg-star bg-cover bg-left lg:bg-center w-full text-center">
      <h1 className="text-4xl text-white font-minecraft pb-10">2027 Batch</h1>
      <div className="flex flex-wrap gap-10 items-center justify-center  h-full pb-10 pt-[130px] px-10 bg-bg-star bg-cover min-h-screen bg-left lg:bg-center">
        <NewTeamCard
          name="Anmol Yadav"
