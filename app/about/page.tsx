  ...
  return (
    <div className="bg-bg-star bg-cover min-h-screen bg-left lg:bg-center">
      ...
      <p className="font-[northwood] text-5xl text-white py-5 px-14">
        <span className="text-[#4DFFDB]">LOCALHOST</span>, a dedicated community
        of developers at <span className="text-[#4DFFDB]">IIIT PUNE</span>, is
        ...
        <span className="text-[#4DFFDB]">Hacktoberfest</span> and{" "}
        <span className="text-[#4DFFDB]">GSoC</span>.
      </p>
      <p className="font-[northwood] text-5xl text-white py-5 px-14">
        We provide a collaborative platform for developers to exchange ideas,
        explore <span className="text-[#4DFFDB]">innovation</span>, and
        ...
        <span className="text-[#4DFFDB]">contributors</span>{" "}
